 ...
 * PlayerEvent.PlayerLoggedOutEvent in PotionsBelt). NeoForge dispatches
 * payload handlers on the main server thread by default (PayloadRegistrar's
 * MAIN HandlerThread), so a plain map is safe here.
 */
